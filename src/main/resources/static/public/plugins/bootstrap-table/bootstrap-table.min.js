...
!function (a) {
    ...
    o.DEFAULTS = {
        ...
        })), this.options.search && (g = [], g.push('<div class="pull-' + this.options.searchAlign + ' search">', c('<input class="form-control' + c(" input-%s", this.options.iconSize) + '" type="text" placeholder="%s">', this.options.formatSearch(this.options.placeholderName)), "</div>"), this.$toolbar.append(g.join("")), d = this.$toolbar.find(".search input"), d.off("keyup drop").on("keyup drop", function (a) {
        ...
        var d, e = this, f = {}, g = {
            ...
            placeholdername: this.options.placeholdername
        };
